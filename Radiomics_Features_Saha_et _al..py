...
d=pd.read_csv('dataset/Imaging_Features.csv')
d=d.iloc[:,1:]
d
...
from Data_preprocessing import initial_feature_selection_var,find_zero_variance_features, initial_feature_selection_corr
...
clinical_features=pd.read_csv('dataset/Clinical_and_Other_Features.csv')
clinical_features
